...
def vector_search(
    df, coll_name, client, k, get_query_func, id2gt_dict, batch_size=50, id_col="paper_id"
):
...
def infer(
    ...
    ground_truths = vector_search(
        df, gt_col, chroma_client, k, get_gt_col, id2gt_dict
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        # required=True,
        default="../data/cnn_news/graph.pickle",
    ...
    parser.add_argument(
        "-kw",
        "--keyword_weights",
        default="../data/cnn_news/keyword_weights.json",
        type=str,
    ...
    id2gt_dict = create_id_to_gt_dict(filtered_data, args.id, "Article text")
