...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Dataset to use (pickle file))",
    )
    parser.add_argument(
        "-c",
        "--collection",
    ...
    parser.add_argument(
        ...
        type=str,
        default="title",
        help="Field to vectorize (title or abstract)",
    )
    parser.add_argument(
        "-t",
        "--type",
        ...
        type=str,
        default="v",
        help="Type of vector database (v or vg)",
    )
    parser.add_argument(
        "-s",
        "--save",
    ...
    parser.add_argument(
        "--list",
        action="store_true",
        help="DO Nothing and List all the vector databases",
    )
